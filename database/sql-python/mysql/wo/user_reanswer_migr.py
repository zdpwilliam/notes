...
def load_answer_data(conn_old):
    sql_forge = "SELECT id, qorder_id, ureanswer_category_id, created_at FROM fb_user_reanswer"
...
def insert_answer(format_answer_tuples):
    ...
    sql_tr = "insert into fb_user_reanswer (id, ticket_id, category_id, created_at) " \
             " VALUES (%s, %s, %s, %s)"
